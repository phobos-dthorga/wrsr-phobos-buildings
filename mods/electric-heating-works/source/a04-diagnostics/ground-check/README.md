...
The subsequent candidate, [08_GROUND_CLEARANCE](../ground-clearance/README.md), restores
the broad ground top at +3 cm while keeping the rest of the plant at its original
height. The author reports that it looks fine now; the 3 cm treatment is accepted
for the next assembly revision. Preserve 07 as the comparison.
